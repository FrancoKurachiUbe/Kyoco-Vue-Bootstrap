	...
	<div class="container">
		<div class="row">
			<article class="col-md-6 col-lg-4 mt-4">
				<img class="img-fluid redondear-img" src="../img-kyco/img/EntradaTorre.jpg" alt="torre Eiffel"/>
			...
			<article class="col-md-6 col-lg-4 mt-4">
				<img class="img-fluid redondear-img" src="../img-kyco/img/bicicleta.jpg" alt="torre Eiffel"/>
				<div class="shadow-lg redondear pad">
			...
			<article class="col-md-6 col-lg-4 mt-4">
				<img class="img-fluid redondear-img" src="../img-kyco/img/ParisDia.jpg" alt="torre Eiffel"/>
				<div class="shadow-lg redondear pad">
			...
			<article class="col-md-6 col-lg-4 mt-4">
				<img class="img-fluid redondear-img" src="../img-kyco/img/crucero.jpg" alt="torre Eiffel"/>
				<div class="shadow-lg redondear pad">
