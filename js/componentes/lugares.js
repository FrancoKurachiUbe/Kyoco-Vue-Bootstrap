  ...
  <div class="container">
    <div class="row">
      <article class="col-md-6 col-lg-4 mt-4">        
            <img class="img-fluid redondear-img" src="../img-kyoco/img/SaiteChapelle.jpg" alt="Saite Chpelle" />
      ...
      <article class="col-md-6 col-lg-4 mt-4">
            <img class="img-fluid redondear-img" src="../img-kyoco/img/NotreDame.jpg" alt="Notre Dame"/>
          <div class="shadow-lg redondear pad">
      ...
      <article class="col-md-6 col-lg-4 mt-4">
        <img class="img-fluid redondear-img" src="../img-kyoco/img/ArcoDeTriunfo.jpg" alt="Arco del triunfo" />
        <div class="shadow-lg redondear pad">
      ...
      <article class="col-md-6 col-lg-4 mt-4">
        <img class="img-fluid redondear-img" src="../img-kyoco/img/JardinLuxemburgo.jpg" alt="Jardin de Luxemburgo" />
        <div class="shadow-lg redondear pad">
      ...
      <article class="col-md-6 col-lg-4 mt-4">
        <img class="img-fluid redondear-img" src="../img-kyoco/img/TorreEiffel.jpg" alt="TorreEiffel"/>
        <div class="shadow-lg redondear pad">
