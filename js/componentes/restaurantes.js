    ...
    <div class="container">
      <div class="row">
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="imagenes/WagonBleu.jpg" alt="Restorante Dessance"/>
        ...
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="imagenes/LeBarbe.jpg" alt="Restorante Dessance"/>
          <div class="shadow-lg redondear pad">
        ...
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="imagenes/LeCaféDesChats.jpg" alt="Restorante Dessance"/>
          <div class="shadow-lg redondear pad">
        ...
        <article class="col-md-6 col-lg-4 mt-4">        
            <img class="img-fluid redondear-img" src="imagenes/Dessance.jpg" alt="Restorante Dessance"/>
        ...
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="imagenes/AutoPassionCafé.jpg" alt="Restorante Dessance"/>
          <div class="shadow-lg redondear pad">
