    ...
    <div class="container">
      <div class="row">
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="../img-kyco/img/WagonBleu.jpg" alt="Restorante Dessance"/>
        ...
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="../img-kyco/img/LeBarbe.jpg" alt="Restorante Dessance"/>
          <div class="shadow-lg redondear pad">
        ...
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="../img-kyco/img/LeCaféDesChats.jpg" alt="Restorante Dessance"/>
          <div class="shadow-lg redondear pad">
        ...
        <article class="col-md-6 col-lg-4 mt-4">        
            <img class="img-fluid redondear-img" src="../img-kyco/img/Dessance.jpg" alt="Restorante Dessance"/>
        ...
        <article class="col-md-6 col-lg-4 mt-4">
          <img class="img-fluid redondear-img" src="../img-kyco/img/AutoPassionCafé.jpg" alt="Restorante Dessance"/>
          <div class="shadow-lg redondear pad">
